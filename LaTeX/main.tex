...
%----------------------------------------------------------------------------------------
\projecttitle{Pixel Classification of Remote Sensing Data - Assessing Impervious and Pervious Surfaces for Rainfall Analysis}
\projecttype{Term Paper 2}
\projectcode{}
\projectdate{\today}
\keywords{classification, deeplearning, machinelearning, remotesensing, landcoverclassification}
...
\addcollaborator{A}{Dr. Johann}{Junghardt}{johann.junghardt@zhaw.ch}{2}
